...
class Schemas
{
    ...
    #[OA\Schema(schema: 'RegisterRequest', type: 'object', required: ['username', 'email', 'password', 'password_confirmation', 'role_id'], properties: [
    ...
    #[OA\Schema(schema: 'VillageResource', type: 'object', properties: [
        ...
        new OA\Property(property: 'malePopulation', type: 'integer', example: 2600),
        new OA\Property(property: 'femalePopulation', type: 'integer', example: 2710),
    ])]
    ...
    #[OA\Schema(schema: 'VillageProfile', type: 'object', properties: [
        ...
        new OA\Property(property: 'area', type: 'number', format: 'float', example: 17.2),
        new OA\Property(property: 'population', type: 'integer', example: 5310),
        new OA\Property(property: 'population_density', type: 'number', format: 'float', example: 308.72),
    ...
    #[OA\Schema(schema: 'VillageDetail', type: 'object', properties: [
        ...
        new OA\Property(property: 'malePopulation', type: 'integer', example: 2600),
        new OA\Property(property: 'femalePopulation', type: 'integer', example: 2710),
        new OA\Property(property: 'populationDensity', type: 'number', format: 'float', example: 308.72),
        new OA\Property(property: 'status', type: 'string', example: 'Aktif'),
